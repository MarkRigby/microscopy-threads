...
### 3D rendering
- This is used for the 3D volume viewer which is included with every copy of NIS-Elements AR and works very nicely, especially for making rendered movies. By defualt it should be set to the New Engine, which is much faster than the Old engine, but its always worth checking. 
